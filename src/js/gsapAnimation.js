...
export function initHeroAnimation() {
    const tlLand = gsap.timeline({ defaults: { duration: 1.75, ease: "power1.out" } });

    tlLand.fromTo('.heroTitle-js', { opacity: 0, y: 30 }, { opacity: 1, y: 0 })
...
export function initStatsAnimation() {
    ...
    mm.add("(min-width: 1025px)", () => {
        ...
        tlClient.fromTo('.statsHeading-js', { opacity: 0, y: 10 }, { opacity: 1, y: 0 });
        ...
        function animateNumber(targetElement, targetNumber, duration) {
            tlStats.to(targetElement, {
                innerText: targetNumber,
                duration: duration,
                snap: { innerText: 1 },
                onUpdate: function () {
                    if (["employeeCount", "happyClientsCount"].includes(targetElement.id)) {
        ...
        animateNumber("#employeeCount", 40, 4.5);
        animateNumber("#experienceYears", 12, 4.5);
        animateNumber("#mobileAppsCount", 20, 4.5);
        animateNumber("#happyClientsCount", 350, 2.5);
    });
    ...
    mm.add("(max-width: 1024px)", () => {
        ...
        tlClientMobile.fromTo('.statsHeading-js', { opacity: 0.2, y: 20 }, { opacity: 1, y: 0 });
        ...
        function animateNumberMobile(targetElement, targetNumber, duration) {
            tlStatsMobile.to(targetElement, {
                innerText: targetNumber,
                duration: duration,
                snap: { innerText: 1 },
                onUpdate: function () {
...
export function initProcessAnimation() {
    ...
    mm.add("(min-width: 1025px)", () => {
        ...
        tlProcess.fromTo('.processHeading', { opacity: 0.4, y: 30 }, { opacity: 1, y: 0, duration: 1 })
        tlProcess.fromTo(".process1-js", { x: "40%", opacity: 0.2 }, { x: "0%", opacity: 1, duration: 4 }, "<35%");
        tlProcess.fromTo(".process2-js", { y: "20%", opacity: 0 }, { y: "0", opacity: 1, duration: 4 });
        tlProcess.fromTo(".process3-js", { x: "-40%", opacity: 0 }, { x: "0", opacity: 1, duration: 4 },);
        tlProcess.fromTo(".process4-js", { x: "40%", opacity: 0 }, { x: "0%", opacity: 1, duration: 4 },);
        tlProcess.fromTo(".process5-js", { y: "-60%", opacity: 0 }, { y: "0", opacity: 1, duration: 4 });
    ...
    mm.add("(max-width: 1024px)", () => {
        ...
        tlProcess.fromTo('.processHeading', { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 2 })
        tlProcess.fromTo(".process1-js", { x: "40%", opacity: 0.2 }, { x: "0%", opacity: 1, duration: 4 }, "<35%");
        tlProcess.fromTo(".process2-js", { y: "20%", opacity: 0 }, { y: "0", opacity: 1, duration: 1 });
        tlProcess.fromTo(".process3-js", { x: "-40%", opacity: 0 }, { x: "0", opacity: 1, duration: 1 },);
        tlProcess.fromTo(".process4-js", { x: "40%", opacity: 0 }, { x: "0%", opacity: 1, duration: 1 },);
        tlProcess.fromTo(".process5-js", { y: "-60%", opacity: 0 }, { y: "0", opacity: 1, duration: 1 });
